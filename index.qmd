...
pie_graph <- data |>
  ...
  mutate(industry_code = parse_number(as.character(INDCAT53)),
         industry_code = ifelse(industry_code == 2, NA, industry_code)) |>
  filter(!is.na(industry_code),industry_code <= 10) |>    #filter main industries only
